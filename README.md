...
本项目基于原作者的水波纹效果进行二次开发与封装，在此特别感谢原作者的创意与实现。
本项目在此基础上优化了水波的表现与交互节奏，使效果在不同页面背景、封面和交互层中使用时更加自然、舒适。

- 原作者：<https://x.com/konmari_tweet>
- 原项目/演示：<https://pastel-lab.pages.dev/flower-water-ripples/>
